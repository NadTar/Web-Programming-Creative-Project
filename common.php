<?php
  ...
  function get_PDO() {
    ...
    $dbname = "mydb";   # fill in with db name containing your SQL tables
    ...
    try {
      ...
      handle_db_error("Can not connect to database. Please try again later");
    }
  }

 /**
  * handles the PDOException error
  * @param {string} - error text
  */
  function handle_db_error($text) {
